...
class MarketsCommodityScreen extends StatefulWidget {
  final TabController tabControllerCommodity;
  const MarketsCommodityScreen({Key? key, required this.tabControllerCommodity})
      : super(key: key);

  @override
  State<MarketsCommodityScreen> createState() => _MarketsCommodityScreenState();
}

class _MarketsCommodityScreenState extends State<MarketsCommodityScreen> {
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: TabBar(
            controller: widget.tabControllerCommodity,
            isScrollable: true,
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: ToggleCircularWidget(
          key: const Key('commodityToggleWidget'),
          height: AppWidgetSize.dimen_40,
